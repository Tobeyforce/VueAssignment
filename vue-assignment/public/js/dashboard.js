(function ($) {
  ...
  $(function () {
    ...
    fetch('https://inlupp-fa.azurewebsites.net/api/total-users')
      .then(res => res.json())
      .then(data => {
        document.getElementById('total-user-amount').innerHTML = `${data.users}`;
        document.getElementById('total-user-growth').innerHTML = `+${data.growth}%`;
    ...
    fetch('https://inlupp-fa.azurewebsites.net/api/total-projects')
      .then(res => res.json())
      .then(data => {
        document.getElementById('total-projects-amount').innerHTML = `${data.projects}%`;
    ...
    fetch('https://inlupp-fa.azurewebsites.net/api/downloads')
      .then(res => res.json())
      .then(data => {
        document.getElementById('downloads-offline').innerHTML = `${data[0].offlineAmount}`;
    ...
    fetch('https://inlupp-fa.azurewebsites.net/api/downloads')
      .then(res => res.json())
      .then(data => {
        document.getElementById('downloads-online').innerHTML = `${data[1].onlineAmount}`;
    ...
    fetch('https://inlupp-fa.azurewebsites.net/api/sales-report')
      ...
      .then(data => {
        ...
        document.getElementById('sale-report-user-amount').innerHTML = `${data.users}`;
